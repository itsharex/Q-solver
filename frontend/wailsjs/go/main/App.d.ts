...
export function IsVoiceAvailable():Promise<boolean>;

export function IsVoiceRecording():Promise<boolean>;

export function MoveWindow(arg1:number,arg2:number):Promise<void>;

export function OnAudioInitStatusChange(arg1:string):Promise<void>;
...
export function Solve(arg1:context.Context,arg2:string):Promise<boolean>;

export function StartRecordingKey(arg1:string):Promise<void>;

export function StartVoiceInput():Promise<void>;

export function StopRecordingKey():Promise<void>;

export function StopVoiceInput():Promise<void>;
